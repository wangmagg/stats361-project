...
do
    ...
    python3 -m plotting.make_plots --net-mdl-saved $net_mdl --expo-mdl-name "one-nbr-expo"
    ...
    do
        ...
        python3 -m plotting.make_plots --net-mdl-saved $net_mdl --expo-mdl-name "frac-nbr-expo-${q}"
    done
done
